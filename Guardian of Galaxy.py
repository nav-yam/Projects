...
def main():
    ...
    class enemy():
        ...
        def __init__(self):
            self.icon = pygame.image.load(
                enemy_icons[random.randint(0, len(enemy_icons) - 1)])
    ...
    if (1):
        ...
        enemy_icons = ["Resources/asteroid-2.png", "Resources/alien.png",
                       "Resources/meteorite.png", "Resources/rock.png"]
        ...
        back = pygame.image.load(
            "Resources/gradient-galaxy-background_23-2148983655-2.jpg")
        brighten = 64
        back.fill((brighten, brighten, brighten),
        ...
        BULLET_FIRE_SOUND = pygame.mixer.Sound(
            'Resources/shotgun-firing-4-6746.mp3')
        Planet_died = pygame.mixer.Sound(
            "Resources/hit-sound-effect-12445.mp3")
        Game_over = pygame.mixer.Sound("Resources/explosion-6801.mp3")
        Emergency = pygame.mixer.Sound(
            "Resources/alarm-loop-sound-effect-94369.mp3")
        musicx = pygame.mixer.Sound(
            "Resources/space-atmospheric-background-124841_5h7XoT8M.mp3")
    ...
    while b:
        ...
        start_font = pygame.font.SysFont("comicsans", 48)
        start_text = start_font.render(
            "Welcome to the Guardians of galaxy", 1, (0, 0, 0))
        screen.blit(start_text, (50, 120))

        start_font = pygame.font.SysFont("comicsans", 20)
        start_text = start_font.render(
            "Hover mouse over the enemies", 1, (175, 60, 30))
        screen.blit(start_text, (30, 300))
        start_text = start_font.render(
            "Press Spacebar or ENTER/RETURN to fire", 1, (175, 60, 30))
        screen.blit(start_text, (30, 330))
    ...
    while b1:
        ...
        exit_text = exit_font.render(
            "Press any key to EXIT", 1, (100, 100, 100))
